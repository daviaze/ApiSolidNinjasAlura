    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAuthentication(auth =>
            {
                ...
                token.TokenValidationParameters = new TokenValidationParameters
                {
                    ...
                    IssuerSigningKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes("dasdadadasdsaadasdasasd")),
            ...
            services.AddScoped<IVilaService, VilaService>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "AluraApiSolid", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "AluraApiSolid v1"));
            }
